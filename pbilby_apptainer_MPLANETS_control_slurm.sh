...
i=0
while [ $i -lt 1 ]; do
    mpirun -np $SLURM_NTASKS apptainer run -B /fred,$HOME /fred/oz002/users/mmiles/apptainer_modern280824.sif python /home/mmiles/soft/GW/ozstar2/enterprise_run_pbilby.py -pulsar $1 -results $2 -noise_search $3 -sampler pbilby -partim /fred/oz002/users/mmiles/MPTA_planet_checker/partim/ -modelfile /fred/oz002/users/mmiles/MPTA_planet_checker/MPTA_DATA_noisemodels.json -noisefile /fred/oz002/users/mmiles/MPTA_planet_checker/MPTA_DATA_and_WN_values.json -nlive 400 -alt_dir out_pbilby_MPLANETS_controlGroup/${1}
